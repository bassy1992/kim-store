...
# Try to use Cloudinary if configured and available
...
# Use S3 if configured and Cloudinary is not set up
if AWS_S3_ENDPOINT_URL and 'cloudinary_storage' not in INSTALLED_APPS:
